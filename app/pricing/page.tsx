...
const Pricing = () => {
  return (
    <div className="isolate overflow-hidden Obg-gray-900">
      <div className="mx-auto max-w-7xl px-6 pb-96 pt-24 text-center sm:pt-32 1g:px-8">
        <div className="mx-auto nax-w-4x1">
        ...
        <div className="relative mt-6">
          ...
          <svg
            ...
            h-[64rem] -translate-x-1/2 [mask-image:radial-gradient(closest-side,white,transparent)] sm:-top-12 md:-top-20 1g:-top-12 xl:top-0"
          >
            <ellipse
              cx={604}
              cy={512}
